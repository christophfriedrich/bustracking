...
import json
url = "https://whitelabel.bahnland-bayern.de/efa/XML_DM_REQUEST?commonMacro=dm&type_dm=any&name_dm=de%3A09663%3A22&outputFormat=rapidJSON&mode=direct&useRealtime=1&includeCompleteStopSeq=1&depType=stopEvents"
